<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ApplyLoan.aspx.cs" Inherits="project_banking.ApplyLoan" %>
...
<asp:Content ID="Content6" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <table>
        ...
        <tr>
            <td>Anual income</td>
            <td>
                <asp:TextBox ID="txtAnul" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Id proof</td>
            <td>
